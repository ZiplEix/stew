...
import (
	...
	stew_guide_ecosystem_creating "github.com/ZiplEix/stew/doc/pages/guide/ecosystem/creating"
	...
	stew_guide_packages_js "github.com/ZiplEix/stew/doc/pages/guide/packages/js"
	stew_guide_packages_nav "github.com/ZiplEix/stew/doc/pages/guide/packages/nav"
	stew_guide_packages_net "github.com/ZiplEix/stew/doc/pages/guide/packages/net"
	...
	stew_guide_summary "github.com/ZiplEix/stew/doc/pages/guide/summary"
...
func RegisterStewRoutes(mux *http.ServeMux) {
	...
	// --- Route: /guide/ecosystem/creating ---
	mux.Handle("GET /guide/ecosystem/creating", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		data := stew.PageData{
			URL:     r.URL.Path,
			Query:   r.URL.Query(),
			Params:  make(map[string]string),
		...
		stew_pages_root.Layout(w, data, func() {
			stew_guide.Layout(w, data, func() {
				stew_guide_ecosystem_creating.Page(w, data)
			})
		})
	}))
	...
	// --- Route: /guide/packages/js ---
	mux.Handle("GET /guide/packages/js", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		data := stew.PageData{
			URL:     r.URL.Path,
			Query:   r.URL.Query(),
			Params:  make(map[string]string),
		...
		stew_pages_root.Layout(w, data, func() {
			stew_guide.Layout(w, data, func() {
				stew_guide_packages_js.Page(w, data)
			})
		})
	}))
	...
	// --- Route: /guide/packages/net ---
	mux.Handle("GET /guide/packages/net", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		data := stew.PageData{
			URL:     r.URL.Path,
			Query:   r.URL.Query(),
			Params:  make(map[string]string),
		...
		stew_pages_root.Layout(w, data, func() {
			stew_guide.Layout(w, data, func() {
				stew_guide_packages_net.Page(w, data)
			})
		})
	}))
	...
	// --- Route: /guide/summary ---
	mux.Handle("GET /guide/summary", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		data := stew.PageData{
			URL:     r.URL.Path,
			Query:   r.URL.Query(),
			Params:  make(map[string]string),
		...
		stew_pages_root.Layout(w, data, func() {
			stew_guide.Layout(w, data, func() {
				stew_guide_summary.Page(w, data)
			})
		})
	}))
	// --- Route: /guide/syntax ---
